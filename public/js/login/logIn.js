...
require(["jquery", "sub"], function ($, Sub) {
    var settings1 = { 
        inpSelector: ["#txtLoginEMail", "#txtLoginPwd", ".inpCap"],
        captchaSessionURL: ["user/check_login", "welcome/index_logined", "admin/admin"],
        subSelector: ".btn", 
        errorShow: "#txtLoginEMail_e", autoload: "#chkRememberMe" }; //账号输入选择器,密码输入选择器,验证码输入框选择器 // 后端文件接收地址，登录成功后跳转的地址 //提交按钮 // 验证码错误显示 //自动登录选择器
